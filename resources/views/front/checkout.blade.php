                ...
                <div class="row">
                    ...
                    <div class="col-md-6" >
                        ...
                        margin-left: 10px; border-radius: 11px;">
                            ...
                            <div class="table-responsive order_table">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        @php 
                                        $totalPrice=$totalPrice+($cart_data->price*$cart_data->qty)
                                        @endphp
                                        <tr>
                                            <td>{{$cart_data->title}} || {{$cart_data->name}}<span class="product-qty"> x{{$cart_data->qty}}</span></td>
                                            <td>RS.{{$cart_data->price*$cart_data->qty}}</td>
                                        </tr>
                                        @endforeach
                                    ...
                                    <tfoot>
                                        ...
                                        <tr style="border-style: hidden;">
                                            <th class="hide shop_coupon_box">Coupon Code <a href="javascript:void(0)" onclick="remove_coupon_code()" class="remove_coupon_code_link">Remove</a></th>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="coupon field_form input-group">
                                        ...
                                        <div class="input-group-append" style="margin-top: 10px;">
                                            <button class="btn btn-fill-out btn-sm apply_coupon_box" type="button"  onclick="applyCouponCode('')">Apply Coupon</button>
                                        </div>
                            ...
                            <input type="button" style="background: #ff1f59; width: 150px; color: #fff;" id="btn" class="btn btn-fill-out checkout" value="Place Order" onclick="pay_now()">
