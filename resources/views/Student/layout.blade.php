                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                ...
                                <li>
                                    <a href="{{asset('Student/edit_profile')}}"> <i class="zmdi zmdi-account"></i> My Profile</a>
                                </li>
                                <li>
                                    
                                        <a href="{{asset('Student/logout')}}"><i class="zmdi zmdi-power"></i> Logout</a>
                                </li>
                    ...
                    <a class="js-arrow" href="#">
                        <div class="account-item clearfix js-item-menu">
                            ...
                            <div class="image img-cir img-120">
                                    <img src="{{asset('assets/images/student/')}}/{{session()->get('STUDENT_IMAGE')}}" alt="John Doe" style="height: 44px;" />
                                    </div>
                                    <div class="content">
                                        {{session()->get('STUDENT_NAME')}}
                                    </div>
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            <a class="js-acc-btn" href="#"> {{session()->get('STUDENT_NAME')}}</a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                
                                                <div class="image img-cir img-120">
                                                    <img src="{{asset('assets/images/student/')}}/{{session()->get('STUDENT_IMAGE')}}" alt="John Doe" style="height: 66px;" />
                                                    </div>
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="#">{{session()->get('STUDENT_NAME')}}</a>
                                                    </h5>
                                                    <span class="email">{{session()->get('STUDENT_EMAIL')}}</span>
                                                </div>
                                            </div>
                                            <div class="account-dropdown__footer">
                                                <a href="{{asset('Student/edit_profile')}}">
