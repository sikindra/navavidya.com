...
<div class="row" style="padding: 20px;">
    ...
    padding: 35px;">
        ...
        <div class="order_details" style=" font-weight: bold; line-height: 31px;">
            Name : {{$product_details[0]->names}} <br>Address : {{$product_details[0]->address1}}<br>City : {{$product_details[0]->city}}<br>State : {{$product_details[0]->state}}<br>Pin Code : {{$product_details[0]->pincode}}<br>
        </div>
    </div>
    <div class="col-md-6" style="border: 1px solid #3c3634;
    border-radius: 5px; margin: 13px;
    padding: 35px;">
        ...
        <div class="order_details" style=" font-weight: bold; line-height: 31px;">
            Order Id : {{$product_details[0]->id}}<br>
            Amount: {{$product_details[0]->total_amt}} <br>
            Invoice Date : {{$product_details[0]->added_on}} <br>
            ...
            <table class="table table-borderless table-data3">
                ...
                <tbody>
                    ...
                    if($product_details[0]->coupon_value>0){
                        ...
                        <td colspan="4" style="border: 1px solid #0c0a0a;"></td>
