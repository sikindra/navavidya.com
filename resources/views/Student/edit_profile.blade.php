            ...
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            ...
                            <div class="has-success form-group">
                                ...
                                <input type="text" id="inputSuccess2i" name="name" value="{{$stu->name}}" class="form-control-success form-control">
                                <input type="hidden" id="inputSuccess2i" name="id" value="{{$stu->id}}" class="form-control-success form-control">
                            </div>
                            <div class="has-warning form-group">
                                <label for="inputWarning2i" class=" form-control-label">Email</label>
                                <input type="text" id="inputWarning2i" name="email" value="{{$stu->email}}" class="form-control-warning form-control">
                            </div>
                            <div class="has-warning form-group">
                                ...
                                <div class="input-group">
                                    <input id="image" name="image" type="file" class="form-control cc-cvc" value="" data-val="true" data-val-required="Please enter the security code"
                                        ...
                                        <div class="ml-2 col-md-12">
                                            <img src="{{asset('assets/images/student/')}}/{{$stu->image}}" id="preview-image-before-upload" class="img-thumbnail" style="max-height:250px; width:250px;">
                                        </div>
                                </div>
                            </div>
                            @endforeach
                ...
                <div class="col-lg-5">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                             <form id="profile" action="{{asset('student/student_profile')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                               
                            <div class="has-success form-group">
                                <label class=" form-control-label">Password</label>
                                <input type="password" id="password" name="password"  class="form-control" required>
                                <input type="hidden" id="inputSuccess2i" name="id" value="{{session()->get('STUDENT_ID')}}" class="form-control-success form-control">
                            </div>
                            <div class="has-warning form-group">
