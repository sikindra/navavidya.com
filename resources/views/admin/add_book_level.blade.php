        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="add_book_level" action="{{asset('')}}admin/add_book_level/insert" method="post" novalidate="novalidate" enctype="multipart/form-data">
                        @csrf
                    ...
                    <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input id="name" name="name" type="text" required class="form-control cc-exp"  data-val="true" data-val-required="Please enter the card expiration"
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <select name="book" id="book" class="form-control-sm form-control" required>
