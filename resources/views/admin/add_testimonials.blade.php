        ...
        <div class="col-lg-12">
            <div class="card">  
                ...
                <div class="card-body">
                    ...
                    <form id="add_testimonials" action="{{asset('admin/testim_insert')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                    <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input id="person_name" name="person_name" type="text" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration"
