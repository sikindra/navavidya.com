        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="add_subcategory" action="{{asset('admin/sub_insert')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                    <div class="row">
                        @foreach ($categories as $list )
                        <div class="col-6">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="cc-exp" class="control-label mb-1">Sub Category names:</label>
                                    <input id="sub_cat_name" name="sub_cat_name" type="text" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration"
