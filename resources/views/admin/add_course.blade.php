        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="add_course" action="{{asset('admin/addcourse/insert')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                    <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="cc-exp" class="control-label mb-1">Category type:</label>
                                    <select id="mode" name="type_id" class="form-control-sm form-control" required>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input id="course_name" name="course_name" type="text" class="form-control cc-exp" required>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input id="levels" name="levels" type="number" class="form-control cc-exp" requird>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input id="sample_video" name="sample_video" type="text" class="form-control cc-exp" required>
