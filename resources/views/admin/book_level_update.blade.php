    ...
    <div class="col-md-12">
        <div class="overview-wrap">
            ...
            <button class="au-btn au-btn-icon au-btn--blue">
                ...
                <a href="{{asset('admin/book_level/')}}/{{$book->book_id}}" style="color: white"> <i class="zmdi zmdi-plus"></i>Bake</a></button>
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{asset('')}}admin/book_level/update/" method="post" novalidate="novalidate" enctype="multipart/form-data">
                        @csrf
