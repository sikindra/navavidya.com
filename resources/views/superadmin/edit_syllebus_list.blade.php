    ...
    <div class="col-md-12">
        <div class="overview-wrap">
            ...
            <button class="au-btn au-btn-icon au-btn--blue">
                @foreach ($syl as $list)
                <a href="{{asset('superadmin')}}/syllebus_list/{{$list->chapter_id}}" style="color: white"> <i class="zmdi zmdi-plus"></i> Bake</a></button>
        </div>
    </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{asset('superadmin/update_syllebus')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                    <div class="row">
