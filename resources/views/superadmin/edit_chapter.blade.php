        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{asset('superadmin/update_chapter')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                    <div class="row">
                        @foreach ($chapter as $list)
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input id="cc-exp" name="chapter_num" type="number" class="form-control cc-exp" value="{{$list->chapter_num}}" data-val="true" data-val-required="Please enter the card expiration"
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input id="cc-exp" name="chapter_name" type="text" class="form-control cc-exp" value="{{$list->chapter_name}}" data-val="true" data-val-required="Please enter the card expiration"
