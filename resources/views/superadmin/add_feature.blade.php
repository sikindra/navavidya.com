    ...
    <div class="col-md-12">
        <div class="overview-wrap">
            ...
            <button class="au-btn au-btn-icon au-btn--blue">
                <a href="{{asset('superadmin/feature_list')}}" style="color: white"> <i class="zmdi zmdi-plus"></i>Bake</a></button>
        </div>
    </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="card">  
                ...
                <div class="card-body">
                    ...
                    <form id="add_feature" action="{{asset('superadmin/feature_insert')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                    <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label class="control-label mb-1">Image Icon tag:</label>
