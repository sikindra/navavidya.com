...
<div class="row">
    <div class="col-md-12">
        <div class="overview-wrap">
            <h4 class="title-1" >Order - {{$product_details[0]->orders_id}}</h4>
            <button class="au-btn au-btn-icon au-btn--blue">
                <a href="{{asset('superadmin/orders')}}" style="color: white"> <i class="zmdi zmdi-plus"></i> Bake</a></button>
        </div>
    </div>
</div>
...
<div class="row m-t-30">
    <div class="col-6">
        <div class="form-group">
            <label for="cc-exp" class="control-label mb-1">Update Order Status:</label>
            <select id="orders_status"  class="form-control-sm form-control" onchange="update_orders_status('{{$product_details[0]->orders_id}}')">
    ...
    <div class="col-6">
        <div class="form-group">
            <label for="cc-exp" class="control-label mb-1">Update Payment Status: </label>
            <select id="payment_status"  class="form-control-sm form-control" onchange="update_payment_status('{{$product_details[0]->orders_id}}')">
            ...
            <b>Track Details</b>
            <form method="post">
            <textarea name="track_details" class="form-control-sm form-control" id="" cols="30" rows="06" required>{{$product_details[0]->track_details}}</textarea>
            <br><input type="submit" value="Update" class="btn btn-lg btn-info btn-block" name="submit">
        @csrf    
        </form>
        </div>
    </div>
