    ...
    <div class="col-md-12">
        <div class="overview-wrap">
            ...
            <button class="au-btn au-btn-icon au-btn--blue">
                <a href="{{asset('superadmin/workshop_list')}}" style="color: white"> <i class="zmdi zmdi-plus"></i>Bake</a></button>
        </div>
    </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="card">  
                ...
                <div class="card-body">
                    ...
                    <form action="{{asset('superadmin/workshop_insert')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input id="cc-exp" name="subject" type="text" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration"
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input id="cc-exp" name="batch" type="text" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration"
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input id="cc-exp" name="batch_from" type="date" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration"
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input id="cc-exp" name="batch_to" type="date" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration"
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input id="cc-exp" name="course_days" type="text" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration"
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input id="cc-exp" name="amount" type="text" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration"
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input id="cc-exp" name="course_time" type="text" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration"
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input id="cc-exp" name="total_classes" type="text" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration"
                        ...
                        <div>
                            <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block" style="text-align: center;">
                                ...
                                <span id="payment-button-amount" >Add Wrokshop </span>
