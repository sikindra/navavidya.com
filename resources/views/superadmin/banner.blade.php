                ...
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <form name="add_index_img " id="add_index_img" method="post" action="{{asset('superadmin/banner_update')}}" enctype="multipart/form-data" class="blockquote blockquote-primary ">
                                    @csrf
                            ...
                            <div class="col-6" >
                                ...
                                <form  method="post" action="{{asset('superadmin/banner_update')}}" enctype="multipart/form-data" >
                                    @csrf 
                                    <div class="row col-md-12 ">
                                        <div class="form-group col-md-8 ">
